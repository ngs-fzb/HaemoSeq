...
###Actual command###
#Download latest AMRFinder plus database (about 0.2 Gb per database). During installation, the database is stored in the conda environment (e.g. /molmyc/miniconda3/envs/AMRFinder/share/amrfinderplus/data/2023-07-13.2). if updated, the older database is not removed!! Remove manual if you want to save space. See info file for the location of database)
